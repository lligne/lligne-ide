...
import {type HeadVertexSet, type HeteroEdgeSet, type HeteroGraph, type TailVertexSet} from "../HeteroGraph"
...
export class MutableHeteroGraphNtoN<TailVertex extends Keyed, HeadVertex extends Keyed, EdgeProperties>
    ...
    ): HeteroEdgeSet<TailVertex, HeadVertex, EdgeProperties> {
        throw Error("Not yet implemented")
    }

    applyToEachHeadVertex(
        callback: (vertex: TailVertex) => void
    ): HeadVertexSet<TailVertex, HeadVertex, EdgeProperties> {
        throw Error("Not yet implemented")
    }

    applyToEachTailVertex(
        callback: (vertex: TailVertex) => void
    ): TailVertexSet<TailVertex, HeadVertex, EdgeProperties> {
        throw Error("Not yet implemented")
    }
